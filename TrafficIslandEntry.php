...
if(isset($_POST['btn_save']))
	{
			$ilat=$_POST['latitude'];
			$ilong=$_POST['longitude'];
			$istatus=$_POST['status'];
			$insqry="insert into tbl_traffic_island(latitude,longitude,t_status)values('$ilat','$ilong','$istatus')";
...
<nav>
    ...
    <li class="active"><a href="TrafficIslandEntry.php" >Traffic Island Entry</a></li>
    ...
    <li class="active"><a href="TrafficIslandEntry.php" class="waves-effect"><i class="material-icons">traffic</i>Traffic Island</a></li>
...
<form id="form1" name="form1" method="post" action="">
    ...
    <div class="input-field">
      <input type="text" name="latitude" id="latitude" required="required"/>
   ...
   <label for="longitude">Longitude</label>
    ...
    <div class="input-field">
      <select name="status" id="status">
          ...
          <option value="2">Dead/Maintenance</option>
      </select>
...
<table class="stripped centered highlight responsive-table">
  ...
  <?php 
	$sel="select * from tbl_traffic_island";
	...
	?>
		<tr>
        <td align="center" width="100"><?php echo $row['latitude'];?></td>
		<td align="center" width="100"><?php echo $row['longitude'];?></td>
